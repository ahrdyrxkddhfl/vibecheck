...
**파이썬만 분석합니다.** 다른 언어 파일은 인덱싱되지 않습니다.
자바와 파이썬이 섞인 레포에서 360개 파일 중 9개만 분석된 적이 있습니다.
지금은 분석하지 못한 파일을 확장자별로 세어 CLI·리포트·웹에 모두 표시하지만,
분석 자체는 하지 않습니다.
...
절을 나누는 규칙이 마크다운 헤딩에 기대고 있기 때ㄹ문입니다.
